...
import BreachProtocol from '../components/BreachProtocol.jsx';
        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-3 justify-end">
              {/* Self-destruct — visible once at least one challenge is done */}
              {completedCount > 0 && (
                <button
                  onClick={() => setBreachActive(true)}
                  className="px-4 py-2 rounded-xl border border-red-700 hover:border-red-500 bg-red-900/20 hover:bg-red-900/40 text-red-400 hover:text-red-300 text-sm font-semibold transition-all"
                >
                  ☢️ Emergency Wipe
                </button>
              )}
